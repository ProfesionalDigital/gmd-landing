        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4 flex flex-col space-y-6">
            ...
            <div className="flex items-center gap-4 pt-2">
              <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white/80 hover:bg-brand-500 hover:text-white transition-all duration-300">
          ...
          <div className="lg:col-span-3 flex flex-col space-y-4 md:pl-8">
            ...
            <ul className="flex flex-col space-y-3">
              {['Movilidad', 'Monitoreo', 'Instrumental', 'Vida Diaria', 'Terapia Respiratoria'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm font-medium hover:text-brand-500 transition-colors duration-200">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div className="lg:col-span-2 flex flex-col space-y-4">
            ...
            <ul className="flex flex-col space-y-3">
              {['Nosotros', 'Distribuidores', 'Garantías', 'Soporte', 'Contacto'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm font-medium hover:text-teal-400 transition-colors duration-200">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div className="lg:col-span-3 flex flex-col space-y-4">
            ...
            <ul className="flex flex-col space-y-5">
              <li className="flex items-start text-sm font-medium">
                ...
                <a href="mailto:ventas@gmd.com.co" className="hover:text-white transition-colors">ventas@gmd.com.co</a>
              </li>
              <li className="flex items-start text-sm font-medium">
                <svg className="w-5 h-5 mr-3 text-teal-400/80 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
